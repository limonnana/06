...
import investmentResolve from './investment-routing-resolve.service';

describe('Investment routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: InvestmentService;
  let resultInvestment: IInvestment | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IInvestment returned by find', () => {
      ...
      expect(resultInvestment).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInvestment).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInvestment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
